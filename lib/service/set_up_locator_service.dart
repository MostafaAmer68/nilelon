...
import 'package:nilelon/features/payments/domain/repositories/payment_repo.dart';
...
void setUpLocatorService() {
  ...
  locatorService
      .registerSingleton<PaymentRepo>(PaymentRepoImpl(locatorService()));
  ...
  locatorService
      .registerSingleton<CategoryRepos>(CategoryReposImpl(locatorService()));
